...
# Load API credentials from the nearest .env file in the project tree.
...
# Chain-of-thought prompt: force the model to reason step by step before answering.
delimiter = "####"
system_message = f"""
...
# Example 1: user question contains a false assumption about product prices.
user_message = f"""
...
# Example 2: user asks about a product category the store does not sell.
user_message = f"""
do you sell tvs"""
messages =  [  
{'role':'system', 
...
# Extract only the final customer-facing answer from the delimited response.
try:
